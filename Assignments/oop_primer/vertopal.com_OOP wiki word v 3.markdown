Object Oriented Programming Wiki Tuesday, April 25, 2023\
10:23 AM
...
declared as static, so there is only one instance of it for the entire
Car
...
> std::cout \<\< \"Number of objects created: \" \<\< MyClass::count
